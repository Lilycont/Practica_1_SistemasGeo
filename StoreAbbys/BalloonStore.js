var cargarGlobos = () => {
    ...
    fetch('https://01hbx16x69.execute-api.us-east-2.amazonaws.com/produccion/api/globos')
...
var cargarRandom = () =>{
    ...
    fetch('https://01hbx16x69.execute-api.us-east-2.amazonaws.com/produccion/api/globos/random')
    .then(response => response.json())
    .then((data) => {
